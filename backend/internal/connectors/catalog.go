...
func mediaProviders() []ProviderSpec {
	return []ProviderSpec{
		...
		{ID: "linkup", DisplayName: "Linkup", Alias: "linkup", Dialect: core.DialectOpenAI,
			...
			Color: "#0EA5E9", Website: "https://linkup.so", APIKeyURL: "https://app.linkup.so/api-keys", SkipValidation: true},
		{ID: "searchapi", DisplayName: "SearchAPI", Alias: "searchapi", Dialect: core.DialectOpenAI,
			...
			Color: "#0EA5A4", Website: "https://www.searchapi.io", APIKeyURL: "https://www.searchapi.io/dashboard", SkipValidation: true},
		{ID: "youcom", DisplayName: "You.com Search", Alias: "youcom", Dialect: core.DialectOpenAI,
			...
			Color: "#7C3AED", Website: "https://you.com", APIKeyURL: "https://api.you.com", SkipValidation: true},
		// Web fetch.
